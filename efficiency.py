...
class TruthMatchLeptonEfficiencyProducer(Module):
    ...
    def beginFile(self, inputFile, outputFile, inputTree, wrappedOutputTree):
        ...
        self.out.branch("GenVisTauFromHiggsTau_matchedRecoTau_idDeepTau2017v2p1VSjet", "I", lenVar="nGenVisTauFromHiggsTau")
        self.out.branch("GenVisTauFromHiggsTau_matchedRecoTau_idDeepTau2017v2p1VSe", "I", lenVar="nGenVisTauFromHiggsTau")
        self.out.branch("GenVisTauFromHiggsTau_matchedRecoTau_idDeepTau2017v2p1VSmu", "I", lenVar="nGenVisTauFromHiggsTau")
        ...
        self.out.branch("GenVisTauFromHiggsTau_matchedRecoBoostedTau_rawDeepTau2018v2p7VSjet", "F", lenVar="nGenVisTauFromHiggsTau")
        ...
        self.out.branch("GenElectronFromHiggsTau_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSjet", "I", lenVar="nGenElectronFromHiggsTau")
        self.out.branch("GenElectronFromHiggsTau_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSe", "I", lenVar="nGenElectronFromHiggsTau")
        self.out.branch("GenElectronFromHiggsTau_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSmu", "I", lenVar="nGenElectronFromHiggsTau")
        ...
        self.out.branch("GenElectronFromHiggsTau_matchedRecoElectron_nearestGenMatchedRecoBoostedTau_rawDeepTau2018v2p7VSjet", "F", lenVar="nGenElectronFromHiggsTau")
    ...
    def analyze(self, event):
        ...
        genElectron_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSjet = []
        genElectron_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSe = []
        genElectron_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSmu = []
        ...
        genElectron_matchedRecoElectron_nearestGenMatchedRecoBoostedTau_rawDeepTau2018v2p7VSjet = []
        ...
        genVisTau_matchedRecoTau_idDeepTau2017v2p1VSjet = []
        genVisTau_matchedRecoTau_idDeepTau2017v2p1VSe = []
        genVisTau_matchedRecoTau_idDeepTau2017v2p1VSmu= []
        ...
        genVisTau_matchedRecoBoostedTau_rawDeepTau2018v2p7VSjet = []
        ...
        if self.isMC:
            ...
            for ivis, vis in enumerate(genvistau):
                ...
                if reco_tau is not None:
                    ...
                    genVisTau_matchedRecoTau_idDeepTau2017v2p1VSjet.append(self._get_hps_tau_deeptau_vsjet(reco_tau))
                    genVisTau_matchedRecoTau_idDeepTau2017v2p1VSe.append(self._get_hps_tau_deeptau_vse(reco_tau))
                    genVisTau_matchedRecoTau_idDeepTau2017v2p1VSmu.append(self._get_hps_tau_deeptau_vsmu(reco_tau))
                else:
                    ...
                    genVisTau_matchedRecoTau_idDeepTau2017v2p1VSjet.append(int(0))
                    genVisTau_matchedRecoTau_idDeepTau2017v2p1VSe.append(int(0))
                    genVisTau_matchedRecoTau_idDeepTau2017v2p1VSmu.append(int(0))
                ...
                if reco_btau is not None:
                    ...
                    genVisTau_matchedRecoBoostedTau_rawDeepTau2018v2p7VSjet.append(self._get_boosted_tau_deeptau_vsjet(reco_btau))
                else:
                    ...
                    genVisTau_matchedRecoBoostedTau_rawDeepTau2018v2p7VSjet.append(float(-999.0))
                ...
                if is_ele_target:
                    ...
                    if reco_idx >= 0:
                        ...
                        if nearest_gm_tau_idx >= 0:
                            ...
                            genElectron_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSjet.append(self._get_hps_tau_deeptau_vsjet(gm_tau))
                            genElectron_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSe.append(self._get_hps_tau_deeptau_vse(gm_tau))
                            genElectron_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSmu.append(self._get_hps_tau_deeptau_vsmu(gm_tau))
                        else:
                            ...
                            genElectron_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSjet.append(int(0))
                            genElectron_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSe.append(int(0))
                            genElectron_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSmu.append(int(0))
                        ...
                        if nearest_gm_btau_idx >= 0:
                            ...
                            genElectron_matchedRecoElectron_nearestGenMatchedRecoBoostedTau_rawDeepTau2018v2p7VSjet.append(self._get_boosted_tau_deeptau_vsjet(gm_btau))
                        else:
                            ...
                            genElectron_matchedRecoElectron_nearestGenMatchedRecoBoostedTau_rawDeepTau2018v2p7VSjet.append(float(-999.0))
        ...
        self.out.fillBranch("GenVisTauFromHiggsTau_matchedRecoTau_idDeepTau2017v2p1VSjet", genVisTau_matchedRecoTau_idDeepTau2017v2p1VSjet)
        self.out.fillBranch("GenVisTauFromHiggsTau_matchedRecoTau_idDeepTau2017v2p1VSe", genVisTau_matchedRecoTau_idDeepTau2017v2p1VSe)
        self.out.fillBranch("GenVisTauFromHiggsTau_matchedRecoTau_idDeepTau2017v2p1VSmu", genVisTau_matchedRecoTau_idDeepTau2017v2p1VSmu)
        ...
        self.out.fillBranch("GenVisTauFromHiggsTau_matchedRecoBoostedTau_rawDeepTau2018v2p7VSjet", genVisTau_matchedRecoBoostedTau_rawDeepTau2018v2p7VSjet)
        ...
        self.out.fillBranch("GenElectronFromHiggsTau_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSjet", genElectron_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSjet)
        self.out.fillBranch("GenElectronFromHiggsTau_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSe", genElectron_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSe)
        self.out.fillBranch("GenElectronFromHiggsTau_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSmu", genElectron_matchedRecoElectron_nearestGenMatchedRecoTau_idDeepTau2017v2p1VSmu)
        ...
        self.out.fillBranch("GenElectronFromHiggsTau_matchedRecoElectron_nearestGenMatchedRecoBoostedTau_rawDeepTau2018v2p7VSjet", genElectron_matchedRecoElectron_nearestGenMatchedRecoBoostedTau_rawDeepTau2018v2p7VSjet)
